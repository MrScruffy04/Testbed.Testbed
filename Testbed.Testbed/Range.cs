...
namespace Testbed.Testbed
{
	...
	public class Range<T> : IComparable<Range<T>>, IComparable<T>, IComparable where T : IComparable<T>
	{
		...
		{
			Contract.Requires((object) lowerBound != null);
			Contract.Requires((object) upperBound != null);
			Contract.Requires(lowerBound.CompareTo(upperBound) <= 0);
		...
		{
			Contract.Requires(value != null);
			Contract.Requires(Overlaps(value));    // Intersect makes no sense unless there is an overlap
		...
		{
			Contract.Requires(value != null);
			Contract.Requires(IsContiguousWith(value));    // Union makes no sense unless there is a contiguous border
		...
		{
			Contract.Requires((object) position != null);
			Contract.Requires(Contains(position));
	...
	public static class Range
	{
		...
		public static RangeArray<T> Create<T>(Range<int> range, T[] values)
		{
			...
			Contract.Requires(values != null);
			Contract.Requires(values.Length > 0);
			Contract.Requires((values.Length == (range.UpperBound - range.LowerBound)));
		...
		{
			Contract.Requires((object) from != null);
			Contract.Requires((object) to != null);
		...
		public static bool Contains<T>(this IEnumerable<Range<T>> ranges, T from, T to) where T : IComparable<T>
		{
			...
			Contract.Requires((object) from != null);
			Contract.Requires((object) to != null);
			Contract.Requires(from.CompareTo(to) <= 0);
		...
		{
			Contract.Requires(ranges != null);
			Contract.Requires((object) range != null);
		...
		{
			Contract.Requires(ranges != null);
			Contract.Requires((object) item != null);
